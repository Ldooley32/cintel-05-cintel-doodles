...
ui.page_opts(title="Ldooley's Omaha,NE Weather Display", fillable=True)
...
with ui.sidebar(open="open"):
    ...
    ui.a(
        "GitHub Source",
        href="https://github.com/Ldooley32/cintel-05-cintel-doodles",
        target="_blank",
    )
    ui.a(
        "GitHub App",
        href="https://github.com/Ldooley32/cintel-05-cintel-doodles/blob/main/dashboard/app.py",
        target="_blank",
    )
   ...
   with ui.value_box(
    ...
    def temperature_status():
        ...
        if temperature < 60:
            ...
            return "Colder than usual. Leave the coat."
        else:
            
            return "Warmer than usual. Leave the coat."
